...
const ChemicalCartridge = () => {
  ...
  return (
    <section ref={rootRef} className="relative">
      ...
      >
        <div className="relative content-box-wrapper opacity-0 hidden lg:grid lg:opacity-100  min-h-[320px] grid-cols-1 items-center lg:min-h-[650px] lg:grid-cols-2 xl:min-h-[900px]">
          <BlurSlideReveal
            ref={blurRevealRef}
            mode="controlled"
